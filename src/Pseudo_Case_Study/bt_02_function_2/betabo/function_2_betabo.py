...
T_values = np.arange(-20, 21, 2)
t2_values = np.arange(5, 21, 1)
beta_values = np.arange(100, 121, 5)
lookup_table = {}
for T in T_values:
    for t2 in t2_values:
        for beta in beta_values:
            lookup_table[(T, t2, beta)] = f_lookup_table(T, t2, beta)
